...
class IndependentreserveOrderBookTests(TestCase):

    def test_snapshot_message_from_exchange(self):
        snapshot_message = IndependentreserveOrderBook.snapshot_message_from_exchange(
            msg={
                "lastUpdateId": 1,
                "bids": [
    ...
    def test_diff_message_from_exchange(self):
        diff_msg = IndependentreserveOrderBook.diff_message_from_exchange(
            msg={
                "e": "depthUpdate",
                "E": 123456789,
                "s": "COINALPHAHBOT",
    ...
    def test_trade_message_from_exchange(self):
        ...
        trade_message = IndependentreserveOrderBook.trade_message_from_exchange(
            msg=trade_update,
            metadata={"trading_pair": "COINALPHA-HBOT"}
        )
