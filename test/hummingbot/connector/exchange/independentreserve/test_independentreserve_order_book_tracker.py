...
class IndependentreserveOrderBookTrackerUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.tracker: IndependentreserveOrderBookTracker = IndependentreserveOrderBookTracker(trading_pairs=[self.trading_pair],
                                                                                              throttler=self.throttler)
        self.tracking_task: Optional[asyncio.Task] = None

        # Simulate start()
        self.tracker._order_books[self.trading_pair] = IndependentreserveOrderBook()
    ...
    def test_exchange_name(self):
        self.assertEqual("independentreserve", self.tracker.exchange_name)

        us_tracker = IndependentreserveOrderBookTracker(trading_pairs=[self.trading_pair],
                                                        domain="us",
                                                        throttler=self.throttler)

        self.assertEqual("independentreserve_us", us_tracker.exchange_name)
    ...
    def test_track_single_book_snapshot_message_with_past_diffs(self):
        ...
        past_diff_msg: OrderBookMessage = IndependentreserveOrderBook.diff_message_from_exchange(
            msg={
                "e": "depthUpdate",
                "E": 123456789,
                "s": "BNBBTC",
    ...
    def test_track_single_book_diff_message(self):
        diff_msg: OrderBookMessage = IndependentreserveOrderBook.diff_message_from_exchange(
            msg={
                "e": "depthUpdate",
                "E": 123456789,
                "s": "BNBBTC",
