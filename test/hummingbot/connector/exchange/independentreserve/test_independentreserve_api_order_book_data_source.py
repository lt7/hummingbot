...
class IndependentreserveAPIOrderBookDataSourceUnitTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.data_source = IndependentreserveAPIOrderBookDataSource(trading_pairs=[self.trading_pair],
    ...
    def test_get_last_trade_prices(self, mock_api):
        ...
        url = utils.public_rest_url(path_url=CONSTANTS.TICKER_PRICE_CHANGE_PATH_URL, symbols=[self.base_asset, self.quote_asset], domain=self.domain)
    ...
    def test_get_throttler_instance(self):
        self.assertIsInstance(IndependentreserveAPIOrderBookDataSource._get_throttler_instance(), AsyncThrottler)
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.independentreserve.independentreserve_api_order_book_data_source"
           ".IndependentreserveAPIOrderBookDataSource._sleep")
