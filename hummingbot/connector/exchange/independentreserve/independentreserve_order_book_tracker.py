...
class IndependentreserveOrderBookTracker(OrderBookTracker):
    ...
    def __init__(self,
        ...
        super().__init__(
            data_source=IndependentreserveAPIOrderBookDataSource(
        ...
        while True:
            try:
                ...
                if message.type is OrderBookMessageType.DIFF:
                    ...
                    if message.content["event"] == "OrderCanceled":
                        continue  # stillTODO

                    if message.content["event"] == "OrderChanged":
                        continue  # stillTODO
