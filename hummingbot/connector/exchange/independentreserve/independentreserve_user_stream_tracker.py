...
from hummingbot.connector.exchange.independentreserve.independentreserve_api_user_stream_data_source \
    import IndependentreserveAPIUserStreamDataSource
...
class IndependentreserveUserStreamTracker(UserStreamTracker):
    _logger: Optional[HummingbotLogger] = None

    def __init__(self, auth: IndependentreserveAuth, domain: str = "com", throttler: Optional[AsyncThrottler] = None):
        super().__init__()
    ...
    def data_source(self) -> UserStreamTrackerDataSource:
        ...
        if not self._data_source:
            self._data_source = IndependentreserveAPIUserStreamDataSource(auth=self._auth, domain=self._domain,
